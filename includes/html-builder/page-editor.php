...
function get_editor_html($page, $action) {
	...
	// page meta
	$html .= "<div class=\"page-meta\"><span style=\"display:hidden\" id=\"isnew\">" . $page->isnew . "</span><p>Title: <input id=\"title\" name=\"title\" style=\"width:252px\" type=\"text\" maxlength=\"200\" autocomplete=\"off\" placeholder=\"Untitled\" value=\"" . $page->title . "\"></p><p>Page ID: <span id=\"id\">" . $page->id . "</span></p><p>Created: " . $page->created . "</p><p>Updated: " . $page->updated . "</p></div>";
